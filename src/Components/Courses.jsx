...
<h2 className='font-poppins text-[2vmax] max-sm:text-[2.6vmax] max-sm:text-center'> Diploma/Advanced Diploma/Bachelor Courses </h2>

</div>

<div className="coursesdiv h-[90vh] max-sm:h-[100vh] w-full bg-[rgb(3,95,172)] flex items-center justify-center px-7 py-5">




<div className="boxesdiv  h-[69vh]  max-sm:h-[60vh] w-[81vw] py-4 px-4 max-sm:w-full">
